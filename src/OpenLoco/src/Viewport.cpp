...
namespace OpenLoco::Ui
{
    ...
    static int16_t sMaxClipHeight = 0x280;
    constexpr int16_t kDefaultClipHeight = 0x280;

    int16_t getMaxClipHeight()
    {
        return sMaxClipHeight;
    }

    void setMaxClipHeight(int16_t maxClipHeight)
    {
        sMaxClipHeight = maxClipHeight;
    }

    void resetMaxClipHeight()
    {
        sMaxClipHeight = kDefaultClipHeight;
    }
}
